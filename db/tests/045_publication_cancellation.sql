...
BEGIN
  ...
  -- The membership guard is the same production trigger used by the API. Seed
  -- the first owner only after establishing the matching actor/workspace
  -- context; this keeps the smoke faithful instead of bypassing the guard.
